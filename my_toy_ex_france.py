...
from toy_model_params.France_parameters import gps_coords
...
from toy_model_params.France_parameters import get_generators, set_gen_as_list_of_gen_units_data
