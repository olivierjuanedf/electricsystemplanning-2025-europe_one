...
def get_generators(country_trigram: str, fuel_sources: Dict[str, FuelSource], wind_on_shore_cf_data: pd.DataFrame,
                   wind_off_shore_cf_data: pd.DataFrame, solar_pv_cf_data: pd.DataFrame, csp_cf_data: pd.DataFrame) -> List[GENERATOR_DICT_TYPE]:
    """
    ...
    generators = [
        {
            ...
            GEN_UNITS_PYPSA_PARAMS.nominal_power: 561.8,
        ...
        },
        {
            ...
            GEN_UNITS_PYPSA_PARAMS.nominal_power: 28327.56,
        ...
        },
        {
            ...
            GEN_UNITS_PYPSA_PARAMS.nominal_power: 5018.49,
        ...
        },
        {
            ...
            GEN_UNITS_PYPSA_PARAMS.nominal_power: 41216.73,
        ...
        },
        {
            ...
            GEN_UNITS_PYPSA_PARAMS.carrier: FuelNames.wind,
            GEN_UNITS_PYPSA_PARAMS.nominal_power: 88,
        ...
        },
        {
            ...
            GEN_UNITS_PYPSA_PARAMS.nominal_power: 40177.08,
        ...
        {
            GEN_UNITS_PYPSA_PARAMS.name: f'{country_trigram}_solar_thermal',
            GEN_UNITS_PYPSA_PARAMS.carrier: FuelNames.solar,
            GEN_UNITS_PYPSA_PARAMS.nominal_power: 2364.5,
            GEN_UNITS_PYPSA_PARAMS.max_power_pu: solar_pv_cf_data['value'].values,
            GEN_UNITS_PYPSA_PARAMS.marginal_cost: fuel_sources[FuelNames.solar].primary_cost
        },
...

        {
            ...
            GEN_UNITS_PYPSA_PARAMS.efficiency: 0.33
                        ...
                        GEN_UNITS_PYPSA_PARAMS.nominal_power: 200,
                        ...
                        GEN_UNITS_PYPSA_PARAMS.nominal_power: 15179,
                        GEN_UNITS_PYPSA_PARAMS.max_hours: 1058,
                        GEN_UNITS_PYPSA_PARAMS.efficiency_store : 0,
                        GEN_UNITS_PYPSA_PARAMS.efficiency_dispatch : 1,
                        #GEN_UNITS_PYPSA_PARAMS.soc_init: 1000000,
                        GEN_UNITS_PYPSA_PARAMS.inflow: np.ones(n_ts)
                },
                                            {
                        GEN_UNITS_PYPSA_PARAMS.name: f'{country_trigram}_hydro-pumped',
                        GEN_UNITS_PYPSA_PARAMS.carrier: 'hydro',
                        GEN_UNITS_PYPSA_PARAMS.nominal_power: 10119,
                        GEN_UNITS_PYPSA_PARAMS.max_hours: 777,
                        GEN_UNITS_PYPSA_PARAMS.efficiency_store : 1,
                        GEN_UNITS_PYPSA_PARAMS.efficiency_dispatch : 1,
                        #GEN_UNITS_PYPSA_PARAMS.soc_init: 1000000,
                        GEN_UNITS_PYPSA_PARAMS.inflow: np.ones(n_ts)
                },
                    ...
                    {
                        GEN_UNITS_PYPSA_PARAMS.name: f'{country_trigram}_flex-demand',
                        GEN_UNITS_PYPSA_PARAMS.carrier: 'Flexibility',
                        GEN_UNITS_PYPSA_PARAMS.nominal_power:  500,
                        GEN_UNITS_PYPSA_PARAMS.marginal_cost : 80
